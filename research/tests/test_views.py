...
class ResearchViewsTests(TestCase):
    ...
    def test_result_view_if_researched_food_is_in_db_and_match_one_food(self):
        ...
        self.assertContains(response, "Aliment à remplacer :", status_code=200)
    ...
    def test_result_view_if_researched_food_in_db_and_match_many_foods(self):
        ...
        self.assertContains(response, "Plusieurs aliments correspondent à votre recherche... "
                                      "Veuillez en choisir un :", status_code=200)
...
class ResearchViewsTestsWithTransaction(TransactionTestCase):
    ...
    def test_result_view_if_substitutes_are_found(self):
        ...
        self.assertContains(response_no_user_logged, "Aliment à remplacer :", status_code=200)
        ...
        self.assertContains(response_user_logged, "Aliment à remplacer :", status_code=200)
