...
class SubstitutesResearchTestsOnlySQL(TransactionTestCase):
    ...
    def setUp(self):
        """ Called to fill the test database for each test method in this class """
    ...
    def test_sql_of_look_for_substitutes(self):
    ...
    def test_sql_of_look_for_foods_matching_user_research(self):
    ...
    def test_sql_of_research_in_db(self, mock_look_food, mock_look_sub):
        ...
        # If called with the research_keywords argument, only 1 test :
        ...
        # If called with the food_barcode argument, 2 tests:
